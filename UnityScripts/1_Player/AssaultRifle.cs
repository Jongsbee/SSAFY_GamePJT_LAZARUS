...
public class AssaultRifle : MonoBehaviour
{
    ...
    private StarterAssets.ThirdPersonControllerForSurvive gunHolder;
    ...
    public ParticleSystem muzzleFlashEffect2; // 총구 화염 효과
    public ParticleSystem muzzleFlashEffect3; // 총구 화염 효과


    public Transform fireTransform; // 총알이 발사될 위치
    public Transform leftHandMount;

    public int rifleDamage; // 공격력
    public float fireDistance = 100f; // 사정거리

    public static int ammoRemain = 2000; // 남은 전체 탄약
    ...
    private void Start()
    {
        rifleDamage = ItemEnums.DamageTable[4];
    }

    public void Setup(StarterAssets.ThirdPersonControllerForSurvive gunHolder)
    {
    ...
    private void Shot(Vector3 startPoint, Vector3 direction)
    {
        ...
        if (Physics.Raycast(startPoint, direction, out hit, fireDistance, ~excludeTarget))
        {
            ...
            if (target != null)
            {
                ...
                {
                    target.transform.GetComponent<Animal>().Damage(rifleDamage, gameObject.transform.position,1);
                }
        ...
        // 남은 탄환의 수를 -1
        magAmmo--;
        UIManager.instance.ammoCnt.text = magAmmo.ToString();
        if (magAmmo <= 0)
    ...
    private IEnumerator ShotEffect(Vector3 hitPosition)
    {
        ...
        muzzleFlashEffect2.Play();
        muzzleFlashEffect3.Play();
    ...
    public bool Reload()
    {
        ...
        // Inventory.Instance.useItemInSlots(62); // 탄알장전
        return true;
    }
    ...
    private IEnumerator ReloadRoutine()
    {
        ...
        UIManager.instance.ammoCnt.text = magAmmo.ToString();
        UIManager.instance.BulletCnt.text = ammoRemain.ToString();
