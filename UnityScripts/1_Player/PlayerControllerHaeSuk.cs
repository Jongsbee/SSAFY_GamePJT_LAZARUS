...
//    void Start()
//    {
//        uiManager = GameObject.Find("Manager").transform.Find("UIManager").GetComponent<UIManager>();
...
//        //TryJump();
//        //Jump();
//        //if (!Inventory.inventoryReady && !Craft.craftModeActivated) 
//        //{
//        //    CameraRotation();
//        //    CharacterRotation();
//        //}

//        //if (!Craft.craftModeActivated)
//        //{
//        //    CameraRotation();
//        //    CharacterRotation();
//        //}
...
//    {
//        if(Input.GetKeyDown("space") && isGround && uiManager.statusController.GetCurrentSP() > 100)
//        {
//            Jump();
//        }
//    }
...
//        {
//            Crouch();
//            uiManager.statusController.DecreaseStamina(100);
...
//    private void TryRun()
//    {
//        if (Input.GetKey(KeyCode.LeftShift) && uiManager.statusController.GetCurrentSP() > 0)
//        {
//            Running();
//        }
       
//        if(Input.GetKeyUp(KeyCode.LeftShift) || uiManager.statusController.GetCurrentSP() <= 10)
//        {
...
//        if (uiManager.statusController.DecreaseStamina(10))
//        {
//            isRun = true;
//            applySpeed = runSpeed;
//        }
