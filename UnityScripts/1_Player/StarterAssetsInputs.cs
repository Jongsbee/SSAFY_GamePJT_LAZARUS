...
namespace StarterAssets
{
	public class StarterAssetsInputs : MonoBehaviour
	{
        ...
        public void OnSwapItem4(InputValue value)
        {
            SwapItem4Input(value.isPressed);
        }
        ...
        {
            bowNArrow = newSwapItem3State;
            
        }

        public void SwapItem4Input(bool newSwapItem4State)
        {
            assaultGun = newSwapItem4State;
        }

        public void ReloadInput(bool newReloadState)
        {
            IsReload = newReloadState;
        }
